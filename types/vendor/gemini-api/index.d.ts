...
// Retrieved from https://github.com/mjesuele/gemini-api-node/blob/master/gemini-api.d.ts
// Updated as of 17 April 2022
...
declare module "gemini-api" {
  export class GeminiAPI {
    ...
    getCurrentAuction(
      ...
      AuctionClosedState | AuctionOpenedState | AuctionIndicativePriceState
    >;
  ...
  export type OrderExecutionOption =
    | "maker-or-cancel"
    | "immediate-or-cancel"
    | "auction-only";
